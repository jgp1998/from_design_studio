...
export function StoreCatalog({ onViewChange, onSelectProduct }: StoreCatalogProps) {
    ...
    const handleProductClick = (productId: string) => {
        ...
        onViewChange('store-product-detail');
    };
        ...
        <div className="min-h-screen bg-slate-50">
            <div className="bg-gradient-to-r from-indigo-600 to-indigo-800 text-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="text-xl text-indigo-100">Ready-to-order 3D printed products with customizable options</p>
                </div>
            </div>
